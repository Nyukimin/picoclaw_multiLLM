...
> 参照: `docs/02_v2統合分割仕様/実装仕様_v2_04_IO契約.md` / `docs/02_v2統合分割仕様/実装仕様_v2_05_ワーカー.md` / 正本 `docs/02_v2統合分割仕様/実装仕様_v2_統合版.md`
...
```json
{
  ...
  "context": {
    "short_memory": "直近はRenCrowのルーティング拡張を設計中。Slack入口。/localあり。",
    "recent_turns": [
