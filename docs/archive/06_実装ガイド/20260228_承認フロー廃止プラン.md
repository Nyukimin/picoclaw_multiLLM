...
RenCrow は当初、破壊的操作の安全性を確保するため、以下の承認フローを設計していた：
...
```
[RenCrow] Auto-commit before patch
[RenCrow] Auto-commit after patch: Add helper function
```
