...
**作成日**: 2026-02-25
**対象**: RenCrow Coder3 + mcp-chrome 統合
...
- **Phase 5-B**: RenCrow 側の MCP クライアント実装
...
- **RenCrow Coder3 仕様**: `docs/05_LLM運用プロンプト設計/Coder3_Claude_API仕様.md`
