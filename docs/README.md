...
| 12_旧OpenClaw差分仕様_20260319/ | OpenClaw機能差分比較表 旧版・詳細実装仕様 旧版 |
| 13_旧設計文書_20260331/ | 仕様_Charペルソナ、仕様_Corderルール、実装仕様_Coder4体化とAgentPersona_v1 |
| 14_スナップショット_20260319/ | 2026-03-19 時点の現況スナップショット |
| 15_TTS仕様_20260331/ | TTS仕様（感情音声システム仕様、Emotion Planner、実装仕様） |
| 16_VTS仕様_20260331/ | VTS仕様（RenCrow VTuber連携） |
