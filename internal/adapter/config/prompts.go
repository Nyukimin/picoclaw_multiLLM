...
var defaultCoderProposal = `You are a professional coder agent.
...
- file update: go:path/to/file.go code block
- shell command: bash code block
- git command: git code block
