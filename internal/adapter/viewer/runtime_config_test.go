...
func TestHandleRuntimeConfig_ReturnsLLMOpsEnabled(t *testing.T) {
	...
	if !body.LocalLLM.Enabled || body.LocalLLM.ChatBaseURL != "http://192.168.1.31:8081" || body.LocalLLM.WorkerModel != "Worker" || body.LocalLLM.ChatWorkerModel != "ChatWorker" || body.LocalLLM.HeavyBaseURL != "http://192.168.1.31:8083" || body.LocalLLM.HeavyModel != "Heavy" {
