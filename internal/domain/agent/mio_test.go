...
func TestParseExplicitCommand_AllRoutes(t *testing.T) {
	...
	tests := []struct {
		...
		{"/code4 prototype feature", routing.RouteCODE4},
		{"CODE: /tmp/example.py を作成してください", routing.RouteCODE2},
		{"code1: 仕様を整理してください", routing.RouteCODE1},
		{"Code2: 実装してください", routing.RouteCODE2},
		{"CODE3: レビューしてください", routing.RouteCODE3},
		{"CODE4: プロトタイプを作ってください", routing.RouteCODE4},
	}
