...
This is a Claude Code launcher for the RenCrow canonical skill.

Before acting, read and follow:

```text
skills/core/launch-readiness-qa-loop/SKILL.md
```

Do not duplicate or override the canonical workflow here. If the workflow changes, update the canonical skill first.
